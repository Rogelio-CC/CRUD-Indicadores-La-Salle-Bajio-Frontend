namespace PruebaAutenticador2.Classes
{
    ...
    public class Indicator
    {
        ...
        // Identificador opcional del usuario responsable a la que aplica el indicador.
        ...
        // Identificador opcional del período escolar a la que pertenece el indicador.
        public Guid PeriodoId { get; set; }

        // Nombre del período escolar.
        public string Periodo { get; set; } = null!;

        // Identificador de la carrera a la que aplica el indicador.
